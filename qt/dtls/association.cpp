...
Association::Association(const QHostAddress &address, quint16 port,
    ...
    crypto(QSslSocket::SslClientMode)
{
    ...
    //! [2]
    connect(&crypto, &QDtls::handshakeTimeout, this, &Association::handshakeTimeout);
    //! [2]
    connect(&crypto, &QDtls::pskRequired, this, &Association::pskRequired);
    //! [3]
    socket.connectToHost(address.toString(), port);
    //! [3]
    //! [13]
    connect(&socket, &QUdpSocket::readyRead, this, &Association::readyRead);
    //! [13]
    //! [4]
    pingTimer.setInterval(5000);
    connect(&pingTimer, &QTimer::timeout, this, &Association::pingTimeout);
    //! [4]
}
...
void Association::startHandshake()
{
    if (socket.state() != QAbstractSocket::ConnectedState) {
        ...
        connect(&socket, &QAbstractSocket::connected, this, &Association::udpSocketConnected);
        return;
    }
